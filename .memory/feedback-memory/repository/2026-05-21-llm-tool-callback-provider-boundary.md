...
summary: 1flowbase 运行时/Native 形状是 provider 唯一真值层；供应商 wire shape 只能由 provider 插件源码适配，plugin host 不替插件改写 tool_calls 或私有协议事件。
keywords:
  - llm tool callback
  - tool_calls
...
updated_at: 2026-05-26 15
last_verified_at: 2026-05-26 15
